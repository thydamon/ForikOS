...
// File Name: user/fork.c
// Create Time: Sat 29 Jan 2022 03:14:46 PM CST
// This is ... 
...
static int32_t copy_pcb_vaddrbitmap_stack0(struct task_struct* child_thread, struct task_struct* parent_thread)
{
    ...
    memcpy(vaddr_btmp, child_thread->user_vaddr.vaddr_bitmap.bits, bitmap_pg_cnt * PG_SIZE);
    child_thread->user_vaddr.vaddr_bitmap.bits = vaddr_btmp;
...
{
    uint8_t* vaddr_btmp = parent_thread->user_vaddr.vaddr_bitmap.bits;
    uint32_t btmp_bytes_len = parent_thread->user_vaddr.vaddr_bitmap.btmp_bytes_len;
    uint32_t vaddr_start = parent_thread->user_vaddr.vaddr_start;
    uint32_t idx_byte = 0;
    uint32_t idx_bit = 0;
